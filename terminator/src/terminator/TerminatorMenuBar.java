...
public class TerminatorMenuBar extends EMenuBar {
    ...
    public static class LlmSuggestAction extends AbstractPaneAction {
        public LlmSuggestAction() {
            super("Suggest");
            putValue(ACCELERATOR_KEY, LlmSuggestController.SUGGEST_KEY_STROKE);
        }

        @Override
        protected void performPaneAction(JTerminalPane terminalPane) {
            terminalPane.getLlmController().suggest();
        }
    }

    public static class LlmPreviewRequestAction extends AbstractPaneAction {
        public LlmPreviewRequestAction() {
            super("Preview Request...");
        }
